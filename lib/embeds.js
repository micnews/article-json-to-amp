...
function renderAd (props) {
  ...
  return (
    `<amp-ad width="${width}" height="${height}" type="${network}" data-slot="${slot}" json='${JSON.stringify(json)}' data-multi-size-validation="false" data-multi-size="${dataMultiSize}"></amp-ad>`
  );
}
