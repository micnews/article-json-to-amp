...
function renderAd (props) {
  ...
  return (
    `<amp-ad width="${width}" height="${height}" type="${network}" data-slot="${slot}" json='${JSON.stringify(json)}' data-multi-size="${multiSize}" data-multi-size-validation="${multiSizeValidation}" layout="${layout}"></amp-ad>`
  );
}
